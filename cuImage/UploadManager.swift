...
//        print("total: \(uploadStatus.totalBytesCount), done: \(uploadStatus.uploadedBytesCount), percent: \(uploadStatus.percent)")
...
//        print("total: \(uploadStatus.totalItemsCount), succeeded: \(uploadStatus.succeededItemsCount), failed: \(uploadStatus.failedItemsCount)")
