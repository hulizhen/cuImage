...
extension NSImage {
    ...
    /// - Parameter factor: Range from 0 to 1,
    ///                     where 0 is the highest compression(lowest size, worst quality).
    /// - Returns: Return compressed image if succeeded, otherwise original image.
